# Makefile.in --
#
#	This file is a Makefile for CTrackStream TEA Extension.  If it has the 
...
#
# RCS: @(#) $Id: Makefile,v 1.1.1.1 2005-10-30 18:45:18 karl Exp $
...
PKG_SOURCES	=  gdtcl.c tclgdtcl.c
PKG_OBJECTS	=  gdtcl.o tclgdtcl.o
...
PKG_LIB_FILE	= libgdtcl0.0.so
PKG_STUB_LIB_FILE = libgdtclstub0.0.a
...
EXEEXT		= 
LDFLAGS_DEFAULT	=  -export-dynamic
...
SHLIB_LD_FLAGS	= 
SHLIB_LD_LIBS	= ${LIBS} -L/usr/local/lib -ltclstub84
STLIB_LD	= ${AR} cr
TCL_DEFS	=  -DTCL_WIDE_INT_TYPE=long\ long -DHAVE_GETCWD=1 -DHAVE_OPENDIR=1 -DHAVE_STRSTR=1 -DHAVE_STRTOL=1 -DHAVE_STRTOLL=1 -DHAVE_STRTOULL=1 -DHAVE_TMPNAM=1 -DHAVE_WAITPID=1 -DNO_VALUES_H=1 -DHAVE_LIMITS_H=1 -DHAVE_UNISTD_H=1 -DHAVE_SYS_PARAM_H=1 -DUSE_TERMIOS=1 -DHAVE_SYS_TIME_H=1 -DTIME_WITH_SYS_TIME=1 -DHAVE_TM_ZONE=1 -DHAVE_GMTIME_R=1 -DHAVE_LOCALTIME_R=1 -DHAVE_TM_GMTOFF=1 -DHAVE_ST_BLKSIZE=1 -DSTDC_HEADERS=1 -DNO_UNION_WAIT=1 -DHAVE_SIGNED_CHAR=1 -DHAVE_PUTENV_THAT_COPIES=1 -DHAVE_LANGINFO=1 -DHAVE_SYS_IOCTL_H=1 -DHAVE_SYS_FILIO_H=1 
TCL_BIN_DIR	= /usr/local/lib/tcl8.4
TCL_SRC_DIR	= ${WRKDIRPREFIX}/usr/ports/lang/tcl84/work/tcl8.4.7
...
INCLUDES	=  -I"/usr/local/include/tcl8.4"
...
# compiled with.
#DEFS		= $(TCL_DEFS) -DPACKAGE_NAME=\"gdtcl\" -DPACKAGE_TARNAME=\"gdtcl\" -DPACKAGE_VERSION=\"0.0\" -DPACKAGE_STRING=\"gdtcl\ 0.0\" -DPACKAGE_BUGREPORT=\"\" -DSTDC_HEADERS=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGS_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_UNISTD_H=1 -DHAVE_LIMITS_H=1 -DHAVE_SYS_PARAM_H=1 -DTCL_WIDE_INT_TYPE=long\ long -DUSE_TCL_STUBS=1  $(PKG_CFLAGS)
DEFS		= -DPACKAGE_NAME=\"gdtcl\" -DPACKAGE_TARNAME=\"gdtcl\" -DPACKAGE_VERSION=\"0.0\" -DPACKAGE_STRING=\"gdtcl\ 0.0\" -DPACKAGE_BUGREPORT=\"\" -DSTDC_HEADERS=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGS_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_UNISTD_H=1 -DHAVE_LIMITS_H=1 -DHAVE_SYS_PARAM_H=1 -DTCL_WIDE_INT_TYPE=long\ long -DUSE_TCL_STUBS=1  $(PKG_CFLAGS)
...
COMPRESS	= tar czvf $(PKG_DIR).tar.gz $(PKG_DIR)
DIST_ROOT	= /tmp/dist
...
dist: dist-clean
	...
	cp -p $(srcdir)/win/*.[ch] $(DIST_DIR)/win
